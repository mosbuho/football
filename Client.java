...
public class Client {
	...
	public static void myInfo(PrintWriter pw, BufferedReader br, String sessionId, ObjectInputStream ois)
		...
		if (response.equals("pass")) {
			try {
				GamerVO user = (GamerVO) ois.readObject();
	...
	public static void teamInfo(ObjectInputStream ois) {
		try {
			List<ClubVO> teamList = (List<ClubVO>) ois.readObject();
	...
	public static void playerInfo(ObjectInputStream ois) {
		try {
			List<PlayerVO> playerList = (List<PlayerVO>) ois.readObject();
	...
	public static void userInfo(ObjectInputStream ois) {
		try {
			List<GamerVO> userList = (List<GamerVO>) ois.readObject();
