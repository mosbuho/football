...
ALTER TABLE GAMER ADD G_POINT NUMBER DEFAULT 0 CHECK (G_POINT >= 0); 
ALTER TABLE GAMER DROP COLUMN G_POINT;

ALTER TABLE GAMER DROP COLUMN G_SESSIONID;
ALTER TABLE GAMER ADD G_SESSIONID CHAR(36);
