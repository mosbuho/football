...
INSERT INTO PLAYER (C_NO, P_NAME, P_UNIFORM_NO, P_POSITION, P_SHO, P_PAS, P_DEF, P_PRICE) VALUES (4, 'Kim Dong Jin', 7, 'fw', 99, 99, 99,  99999999);
...
UPDATE GAMER SET G_SESSIONID = NULL;

UPDATE GAMER SET G_ISADMIN = 1 WHERE G_NO = 1;
UPDATE GAMER SET G_BALANCE = 1000000 WHERE G_NO = 2;